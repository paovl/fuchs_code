...
if '__main__':
    ...
    dict_standar_file = 'dict_raw_scores.pkl'
    ...
    model_dir = ['no_deactivate_seed0_dseed0_th0.04_a500_sigmoidWeightedLoss(full DB)_bio']

    bio_model_standar_scores_path = f"{bio_data_dir}/{'results_nn_5fold'}/{dict_standar_file_bio}"
    ...
    for dir in model_dir:
        ...
        model_standar_scores_path = f"{data_dir}/{dir}/{'results_nn_5folds'}/{dict_standar_file}"
