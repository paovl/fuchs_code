...
if __name__ == '__main__':
    ...
    for iter in range(iterations):
        ...
        full_dataset=EyeDataset(csvFile, imageDir,transform=None,mapList=None,test=False,random_seed=random_seed)
        ...
        # Test regressor
        AUCs[iter] = gs_lr.score(Xtest_s, Ytest) # Save test AUC
        ...
        scores_matrix[test_idxs, iter] = logits
    ...
    # Show results
    print('\n\nFinal results with %d iterations with:\navgAUC %f\n\n'%(iterations,AUCs.mean()))
    with open(text_file, "a") as file:
            file.write('\n\n Final results with %d iterations with avgAUC %f\n\n'%(iterations,AUCs.mean()))
