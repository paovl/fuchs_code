...
class LocalNCCLoss(torch.nn.Module):                                                                                                   
    ...
    def forward(self, img1, mask, img2, normalizer):
        ...
        local_ncc_inv = 1 - local_ncc

        if self.reduction == 'mean':
            local_ncc_loss = local_ncc_inv.mean()
        else:
            local_ncc_loss = local_ncc_inv

        return local_ncc_loss, img1, img2
