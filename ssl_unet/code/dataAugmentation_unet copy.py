...
class RandomJitter(object):
    ...
    def __call__(self, sample):
        ...
        for c in range(channels):
            ...
            # error[:,:,c][mask_error_bg] = -100

        jitter_image = image
                 
        return {'image': jitter_image}
        # return {'image': image_shift, 'error': error}
...
class cropEye(object):
    ...
    def __call__(self, sample):
        ...
        # return {'image': image_cropped, 'error': error_croped}
...
class centerCrop(object):
    ...
    def __call__(self, sample):
        ...
        # return {'image': image_cropped, 'error': error}
